    ...
    <AboutUsConteiner id="about">
      <AboutUsImageBlock>
        <picture>
          ...
          <source media="(max-width: 1200px)" srcSet={aboutUsImageSecond768} />
      ...
      <AboutUsBlock>
        ...
        <AboutUsText>
          ...
          Leister. Компанія «Alltenta» виробляє наступну продукцію:
          <br /> - М’які вікна для альтанок, бесідок, терас та балконів
          <br /> - Штори ПВХ для авто мийок, СТО та складських приміщень <br />{' '}
          - Тенти на пікапи, легкові, зерновози та вантажні авто <br /> -
          ...
          Bozamet. Працюємо по всій території України, замовлення доставляються
          будь-яким перевізником за побажанням клієнта. Ми працюємо для Вас,
          задоволений клієнт – наша найголовніша нагорода. Телефонуйте та
          замовляйте саме те що потрібно Вам на вигідних умовах.
        </AboutUsText>
        <AboutUsButton>
          Наші роботи
          <AboutUsArrow />
