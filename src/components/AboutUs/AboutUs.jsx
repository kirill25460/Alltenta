    ...
    <AboutUsConteiner id="about">
      ...
      <AboutUsBlock>
        ...
        <AboutUsText>
          ...
          Leister. Компанія «Alltenta» виробляє наступну продукцію: М’які вікна
          для альтанок, бесідок, терас та балконів Штори ПВХ для авто мийок, СТО
          та складських приміщень Тенти на пікапи, легкові, зерновози та
          вантажні авто Накриття з ПВХ тканини Транспортувальні чохли для лодок
          Стрічкові завіси ПВХ Індивідуальні вироби з ПВХ під замовлення Ремонт
          виробів з ПВХ Терміни виконання замовлення становлять 1-3 дні. У
