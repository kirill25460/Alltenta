...
export const AdditionalInformation = () => {
  return (
    <AdditionalInformationConteiner>
      ...
      <AdviceBlock>
        <AdviceMainText>Доставка</AdviceMainText>
        <AdviceText>
        ...
        <AdviceMainText>Повернення і обмін</AdviceMainText>
        <AdviceText>
          Компанія "ПВХ штори" здійснює повернення та обмін товарів належної
          якості відповідно до Закону « Про захист прав споживачів ». Обмін або
          повернення не стосується виробів виготовлених за Пускозарядний
          розміром. Строки повернення і обміну Повернення і обмін товарів
          можливий протягом 14 днів після отримання товару покупцем. Зворотній
          доставка товарів здійснюється за домовленістю. Умови повернення для
          товарів належної якості Відповідно до Закону «Про захист прав
          споживачів», компанія може відмовити споживачеві в обміні і поверненні
          товарів належної якості, якщо вони відносяться до категорій,
          зазначених у чинному Переліку непродовольчих товарів належної якості,
          що не підлягають поверненню та обміну.
        </AdviceText>
      </AdviceBlock>
    </AdditionalInformationConteiner>
  );
